...
Для загрузки файла с GitHub используем команду **git clon** далее вставляем ссылку на репозиторий, ссылку берем со вкладки **cod** принадлежащей требуему репозиторию
...
## Скачивание файлов из GitHub с уже подключенным репозиторием

Rоманда позволяет скачать все из текущего репозитория и автоматически
...
Для изменения названия ветки используем:
...
Для сливание ветки с ответвлением ислпользем:
